...
export default function Footer() {
  return (
    <SectionLayout classNames="bg-[#333333] mb-0">
      <footer className="grid grid-cols-1 px-8 pt-8 pb-10 mt-5 text-left text-white lg:gap-0 md:justify-items-center lg:pb-24 sm:px-0 sm:grid-cols-2 sm:gap-x-64 lg:gap-x-12 md:gap-x-10 md:grid-cols-4 lg:flex lg:justify-between md:text-left xl:flex xl:gap-16 2xl:px-4">
        {footerMenu.map((menu) => (
          ...
          <div className="flex flex-col gap-3">
            <div className="flex gap-3 sm:justify-center">
              ...
              <div className="text-[15px] sm:text-left">
                <p>Building no. 11, Road 01, Block #H,</p>
                <p>Halishahar, Chattagram, Bangladesh.</p>
              </div>
            </div>
            <div className="flex items-center gap-3 sm:justify-center lg:justify-start">
              ...
              <p className="">start@zorgitgroup.com</p>
            </div>
